...
def main():
    ...
    # Banks handlers
    app.add_handler(CommandHandler("bancos", banks_handlers.bancos_command))
    app.add_handler(CommandHandler("minhas_solicitacoes", banks_handlers.minhas_solicitacoes_command))
    app.add_handler(CommandHandler("admin_bancos", banks_handlers.admin_bancos_command))
    ...
    # Callback handlers
    app.add_handler(CallbackQueryHandler(banks_handlers.handle_bank_callbacks, pattern=r'^bank_.*|^admin_(view_requests|bancos_back|add_bank|edit_bank|add_subcat)$'))
